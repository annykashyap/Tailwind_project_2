...
import tele from "../../Img/telephone_trio_nirala.png";
    ...
    <div class="flex md:ml-auto md:mr-0 mx-auto items-center flex-shrink-0 space-x-4">
      <button class="bg-gray-100 inline-flex py-3 px-5 rounded-lg items-center hover:bg-gray-200 focus:outline-none">
        ...
        <span class="ml-4 flex items-start flex-col leading-none">
          <span class="text-xs text-gray-600 mb-1">GET An</span>
          <NavLink to='/formpage'>
          <span class="title-font font-medium">Appointment</span>
          </NavLink>
        </span>
      </button>
      <button class="bg-gray-100 inline-flex py-3 px-5 rounded-lg items-center hover:bg-gray-200 focus:outline-none">
        ...
        <span class="ml-4 flex items-start flex-col leading-none">
          <span class="text-xs text-gray-600 mb-1">Get in touch in</span>
          <span class="title-font font-medium">What's App</span>
        </span>
      </button>
    </div>
  </div>
